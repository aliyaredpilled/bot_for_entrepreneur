...
### 1.2 [ ] Сохранение текстовых сообщений
...
### 2.3 [ ] Сохранение голосовых и видео-кружков
...
### 3.1 [ ] Базовая интеграция Claude Agent SDK
...
### 3.3 [ ] Динамический system prompt
...
### 4.2 [ ] Сохранение контекста между сообщениями
...
### 5.1 [ ] Парсинг путей в ответах агента
...
### 5.3 [ ] Маскировка путей в ответах
...
### 6.1 [ ] Редактируемое сообщение со статусом
...
### 6.2 [ ] Минимальное время показа статуса (2 сек)
...
### 6.3 [ ] Маппинг инструментов на человеческие названия
...
### 6.4 [ ] Показ промежуточных реплик агента
...
### 6.5 [ ] Финальный ответ заменяет статусы
...
|--------|-------|--------|--------|
| 1. Архивация текста | 3 | 0 | ⬜ |
| 2. Архивация медиа | 3 | 0 | ⬜ |
| 3. AI-агент | 4 | 0 | ⬜ |
| 4. Сессии и память | 3 | 0 | ⬜ |
