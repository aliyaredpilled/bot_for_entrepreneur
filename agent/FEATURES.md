...
### 3.5 [x] Улучшенный системный промпт
...
### 6.6 [x] Чистые промежуточные реплики и дедупликация финала
...
### 9.1 [x] Структурированные логи в stdout
